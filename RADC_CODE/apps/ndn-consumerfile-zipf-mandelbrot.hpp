...
#ifndef NDN_CONSUMER_FILE_ZIPF_MANDELBROT_H_
#define NDN_CONSUMER_FILE_ZIPF_MANDELBROT_H_
 ...
 */
class ConsumerfileZipfMandelbrot : public ConsumerCbrFile {
public:
  static TypeId
  GetTypeId();
   ...
   */
  ConsumerfileZipfMandelbrot();
  virtual ~ConsumerfileZipfMandelbrot();
...
#endif /* NDN_CONSUMER_FILE_ZIPF_MANDELBROT_H_ */
