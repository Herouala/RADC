...
main(int argc, char* argv[])
{
  ...
  topologyReader.SetFileName("src/ndnSIM/examples/topologies/K-tree-Depth-6.txt");
  topologyReader.Read();
  ...
  consumerHelper.SetPrefix("/home/mohammed/Desktop/ndnSIM/consumer7.txt");
  consumerHelper.Install(consumer7);
  
  consumerHelper.SetPrefix("/home/mohammed/Desktop/ndnSIM/consumer8.txt");
  consumerHelper.Install(consumer8);
  
  consumerHelper.SetPrefix("/home/mohammed/Desktop/ndnSIM/consumer9.txt");
  consumerHelper.Install(consumer9);
  
  consumerHelper.SetPrefix("/home/mohammed/Desktop/ndnSIM/consumer10.txt");
  consumerHelper.Install(consumer10);
  
  consumerHelper.SetPrefix("/home/mohammed/Desktop/ndnSIM/consumer11.txt");
  consumerHelper.Install(consumer11);
  
  consumerHelper.SetPrefix("/home/mohammed/Desktop/ndnSIM/consumer12.txt");
  consumerHelper.Install(consumer12);
  
  consumerHelper.SetPrefix("/home/mohammed/Desktop/ndnSIM/consumer13.txt");
  consumerHelper.Install(consumer13);
  
  consumerHelper.SetPrefix("/home/mohammed/Desktop/ndnSIM/consumer14.txt");
  consumerHelper.Install(consumer14);
  
  consumerHelper.SetPrefix("/home/mohammed/Desktop/ndnSIM/consumer15.txt");
  consumerHelper.Install(consumer15);
  
  consumerHelper.SetPrefix("/home/mohammed/Desktop/ndnSIM/consumer16.txt");
  consumerHelper.Install(consumer16);
  
  consumerHelper.SetPrefix("/home/mohammed/Desktop/ndnSIM/consumer17.txt");
 ...
 // Calculate and install FIBs
  ...
  //ndn::AppDelayTracer::InstallAll("//home/mohammed/Desktop/UATL0.1/My-app-delays-trace-tree6.csv");
